...
intro() {
    ...
    <div class="intro">
        Hi. 
        <div class="hot-links">
            <a href="https://liams.me/index.xml" class="feed-button">Subscribe</a>
            <a href="https://www.paypal.com/paypalme/liamscalzulli" class="donate-button" target="_blank">Donate</a>
        </div>
...
cat >> ./docs/index.html << EOF
    ...
    <div class="footer">
        ...
        <a href="mailto:liam@liams.me">Mail</a> · 
